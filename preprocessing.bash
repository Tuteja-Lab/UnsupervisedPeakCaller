...
helpFunction()
{
	...
	echo -e "\t-o Absolute directory of output files (DEFAULT: $indir)."
	echo -e "\t-g Genome the data are aligned to. Currently support mm10 (Ensembl), hg38 (Ensembl) (DEFAULT: $genome)."
